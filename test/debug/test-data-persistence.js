...
async function testDataPersistence() {
    ...
    try {
        ...
        console.log('=== Testing Advanced Skills Data Persistence ===');
        ...
        await page.screenshot({ 
            path: 'test-data-persistence.png', 
            fullPage: true 
        });
        
        console.log('\n✓ Data persistence test completed - screenshot saved');
